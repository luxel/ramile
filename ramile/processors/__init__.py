...
class FileProcessor(object):
    ...
    def __build_processors(self):
        ...
        self.__cache_processor(KTProcessor())
        self.__cache_processor(XmlProcessor())
        return
...
from ramile.processors.xml_processor import XmlProcessor
...
from ramile.processors.kt_processor import KTProcessor
